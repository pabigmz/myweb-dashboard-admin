...
<div class="wrapper">
  ...
  }elseif(isset($_REQUEST['mode']) && $_REQUEST['mode']=='product'){
    include("product_type_list.php");
  }elseif(isset($_REQUEST['mode']) && $_REQUEST['mode']=='add_product'){
    include("product_type_form_add.php");
  }elseif(isset($_REQUEST['mode']) && $_REQUEST['mode']=='edit_product'){
    include("product_type_form_edit.php");
  }elseif(isset($_REQUEST['mode']) && $_REQUEST['mode']=='del_product'){
    include("product_type_form_del.php");
  }
  else{
